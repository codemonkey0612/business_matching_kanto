...
<div class="relative -mx-5 -mt-8 mb-8 overflow-hidden" style="height:200px">
  ...
  <div class="absolute inset-0 pointer-events-none"
       style="background:linear-gradient(135deg,rgba(6,6,20,0.55) 0%,rgba(6,6,20,0.22) 60%,transparent 100%),
              linear-gradient(180deg,transparent 40%,rgba(6,6,20,0.50) 100%)"></div>
...
<div class="text-center">
  ...
  {{-- 説明文 --}}
  <p class="reveal text-fumi leading-relaxed mb-8 px-2" style="font-size:14px; transition-delay:0.10s">
    双方の連絡先を含むメールをお送りしました。<br>
    メールをご確認のうえ、直接ご連絡ください。
  </p>

  {{-- 区切り装飾 --}}
  <div class="reveal flex items-center justify-center gap-3 mb-8" aria-hidden="true" style="transition-delay:0.18s">
  ...
  {{-- 補足説明 --}}
  <div class="reveal bg-white border border-[#E8E4DC] rounded px-5 py-4 mb-8 text-left"
       style="box-shadow:0 1px 2px rgba(0,0,0,0.04); transition-delay:0.26s">
  ...
  <a href="{{ route('matching.index') }}"
     class="reveal inline-flex items-center justify-center gap-2 bg-enji text-white font-medium tracking-widest
            rounded px-8 py-3.5 min-h-[48px] w-full
            transition-opacity ease-out"
     style="font-size:15px; transition-duration:150ms; transition-delay:0.34s"
