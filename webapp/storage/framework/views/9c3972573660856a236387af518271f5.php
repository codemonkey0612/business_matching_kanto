...
<title><?php echo $__env->yieldContent('title', 'ビジネスマッチング'); ?></title>
...
<main class="max-w-lg mx-auto px-5 py-8 page-enter">
  ...
  <?php if(session('success')): ?>
    <div x-data="{ show: true }" x-show="show" x-cloak
      ...
      <span class="text-matcha" style="font-size:14px"><?php echo e(session('success')); ?></span>
...
<?php /**PATH C:\dev\business_matching\webapp\resources\views/layouts/app.blade.php ENDPATH**/ ?>