...
<body class="bg-washi min-h-screen flex flex-col">
  ...
  <div class="relative shrink-0 overflow-hidden" style="height: min(58vh, 430px);">
    ...
    <div class="absolute inset-0 pointer-events-none" aria-hidden="true"
         style="background:
           linear-gradient(135deg, rgba(6,6,16,0.30) 0%, transparent 45%),
           linear-gradient(180deg, transparent 38%, rgba(6,6,16,0.68) 100%)"></div>
    ...
    <div class="absolute bottom-0 left-0 right-0 px-6 pb-8 z-10">
      ...
      <h1 class="font-mincho text-white mb-2"
          style="font-size:clamp(28px,8vw,36px); line-height:1.25; letter-spacing:0.05em;
  ...
  <div style="background:#8B2635; padding:10px 24px">
    <div class="max-w-sm mx-auto flex items-center gap-3">
      <span class="font-medium text-white/90" style="font-size:10px; letter-spacing:0.22em">LOGIN</span>
      <div class="h-px flex-1" style="background:rgba(255,255,255,0.22)"></div>
      <span style="font-size:11px; color:rgba(255,255,255,0.55); letter-spacing:0.06em">アカウントにログイン</span>
    </div>
  </div>

  
  <div class="form-panel flex-1 px-5 pt-8 pb-10" style="background:#FAFAF7">
    <div class="max-w-sm mx-auto">
      ...
      <form method="POST" action="<?php echo e(route('login')); ?>" x-data="{ showPw: false }" novalidate>
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
            <p id="email-error" class="mt-1.5 text-enji" style="font-size:13px" role="alert">
              <?php echo e($message); ?>
        ...
        <div class="mb-8">
          ...
          <div class="relative">
            ...
            <button
              type="button"
              @click="showPw = !showPw"
              class="absolute right-3.5 top-1/2 -translate-y-1/2 text-fumi hover:text-sumi transition-opacity p-1"
...
<?php /**PATH C:\dev\business_matching\webapp\resources\views/auth/login.blade.php ENDPATH**/ ?>