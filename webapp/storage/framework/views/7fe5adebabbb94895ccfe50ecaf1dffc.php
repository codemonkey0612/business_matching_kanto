...
<div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:22px;flex-wrap:wrap;gap:12px">
  ...
  <?php if($hasFail): ?>
    <a href="<?php echo e(route('admin.notifications.index', ['status'=>'failed'])); ?>"
      ...
      失敗 <?php echo e($stats['mail_failed']); ?>件
    </a>
  <?php endif; ?>
</div>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
  ...
  <div class="kpi-card" style="background:linear-gradient(135deg,#6366F1 0%,#8B5CF6 100%);--shadow:rgba(99,102,241,0.30)">
    ...
    <p class="kpi-num"><?php echo e($stats['total']); ?></p>
    ...
    <div class="kpi-footer">
      <div style="display:flex;gap:16px">
        <div>
          ...
          <p style="font-size:18px;font-weight:800;color:white;line-height:1;font-family:'Inter',sans-serif"><?php echo e($stats['completed']); ?></p>
        </div>
        <div>
          ...
          <p style="font-size:18px;font-weight:800;color:rgba(255,255,255,0.75);line-height:1;font-family:'Inter',sans-serif"><?php echo e($stats['draft']); ?></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="kpi-card" style="background:linear-gradient(135deg,#3B82F6 0%,#06B6D4 100%);--shadow:rgba(59,130,246,0.28)">
    ...
    <p class="kpi-num"><?php echo e(number_format($stats['display_count'])); ?></p>
    ...
    <div class="kpi-footer">
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <p style="font-size:12px;color:rgba(255,255,255,0.65);font-family:'Inter',sans-serif">平均 <strong style="color:white;font-size:14px;font-weight:700"><?php echo e($avgViews); ?></strong> 回/人</p>
      </div>
    </div>
  </div>
  ...
  <div class="kpi-card" style="background:linear-gradient(135deg,#10B981 0%,#0D9488 100%);--shadow:rgba(16,185,129,0.28)">
    ...
    <p class="kpi-num"><?php echo e($stats['contacts']); ?></p>
    ...
    <div class="kpi-footer">
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <p style="font-size:12px;color:rgba(255,255,255,0.65);font-family:'Inter',sans-serif">連絡率 <strong style="color:white;font-size:14px;font-weight:700"><?php echo e($contactRate); ?>%</strong></p>
      </div>
    </div>
  </div>

  <div class="kpi-card" style="background:<?php echo e($hasFail ? 'linear-gradient(135deg,#EF4444 0%,#DC2626 100%)' : 'linear-gradient(135deg,#F59E0B 0%,#F97316 100%)'); ?>;--shadow:<?php echo e($hasFail ? 'rgba(239,68,68,0.28)' : 'rgba(245,158,11,0.28)'); ?>">
    <div class="blob1"></div><div class="blob2"></div><div class="blob3"></div>
    <div class="kpi-icon">
    ...
    <p class="kpi-num"><?php echo e($stats['mail_sent']); ?></p>
    ...
    <div class="kpi-footer">
      <?php if($hasFail): ?>
        <div style="display:flex;align-items:center;gap:6px">
          ...
          <p style="font-size:12px;font-weight:600;color:white;font-family:'Noto Sans JP',sans-serif">失敗 <?php echo e($stats['mail_failed']); ?>件あり</p>
        </div>
      <?php else: ?>
        <div style="display:flex;align-items:center;gap:6px">
...
<div style="background:#fff;border:1px solid #E8EAED;border-radius:16px;padding:18px 20px;margin-bottom:20px;box-shadow:0 2px 8px rgba(0,0,0,0.04)">
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px">
    ...
    <div style="display:flex;align-items:baseline;gap:3px">
      <span style="font-size:26px;font-weight:800;color:#6366F1;font-family:'Inter',sans-serif;line-height:1;letter-spacing:-0.03em"><?php echo e($completionRate); ?></span>
  ...
  <div style="height:10px;background:#F1F5F9;border-radius:100px;overflow:hidden;position:relative">
    <div style="height:100%;width:<?php echo e($completionRate); ?>%;background:linear-gradient(90deg,#6366F1,#8B5CF6);border-radius:100px;transition:width .8s ease;position:relative">
  ...
  <div style="display:flex;justify-content:space-between;margin-top:10px">
    <div style="display:flex;align-items:center;gap:5px">
      ...
      <span style="font-size:12px;color:#10B981;font-weight:600;font-family:'Inter',sans-serif">完了 <?php echo e($stats['completed']); ?>名</span>
    </div>
    <div style="display:flex;align-items:center;gap:5px">
      <span style="width:8px;height:8px;background:#F59E0B;border-radius:50%;display:inline-block"></span>
      <span style="font-size:12px;color:#D97706;font-weight:600;font-family:'Inter',sans-serif">途中 <?php echo e($stats['draft']); ?>名</span>
    </div>
  </div>
</div>
  ...
  <?php else: ?>
    <div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
      <table class="cool-table" style="min-width:520px">
        ...
        <tbody>
          <?php $__currentLoopData = $recentContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          <tr>
            <td style="padding-left:20px;width:40px">
              <span style="font-size:11px;font-weight:600;color:#CBD5E1;font-family:'Inter',sans-serif"><?php echo e(str_pad($loop->index + 1, 2, '0', STR_PAD_LEFT)); ?></span>
            </td>
            <td>
              <div style="display:flex;align-items:center;gap:10px">
                <div style="width:34px;height:34px;border-radius:10px;background:<?php echo e($avc); ?>;display:flex;align-items:center;justify-content:center;color:white;font-size:13px;font-weight:800;flex-shrink:0;font-family:'Inter',sans-serif;box-shadow:0 0 0 2px #fff,0 0 0 3.5px <?php echo e($avc); ?>66"><?php echo e($initial); ?></div>
                <div>
                  <p style="font-size:13px;font-weight:600;color:#1E293B;line-height:1.3;font-family:'Noto Sans JP',sans-serif;white-space:nowrap"><?php echo e($fromName); ?></p>
                  <?php if($fromCompany): ?>
                    <p style="font-size:11px;color:#94A3B8;line-height:1.3;font-family:'Noto Sans JP',sans-serif;white-space:nowrap"><?php echo e($fromCompany); ?></p>
                  <?php endif; ?>
                </div>
              </div>
            </td>
            <td>
              <div style="display:flex;align-items:center;gap:8px">
                ...
                <div>
                  <p style="font-size:13px;color:#475569;font-family:'Noto Sans JP',sans-serif;white-space:nowrap;font-weight:500"><?php echo e($toName); ?></p>
                  <?php if($toCompany): ?>
                    <p style="font-size:11px;color:#94A3B8;font-family:'Noto Sans JP',sans-serif;white-space:nowrap"><?php echo e($toCompany); ?></p>
                  <?php endif; ?>
                </div>
              </div>
            </td>
            ...
            <td style="padding-right:20px">
              <span style="font-family:'Inter',sans-serif;font-size:12px;color:#94A3B8;font-weight:500;white-space:nowrap"><?php echo e($cr->created_at->format('m/d H:i')); ?></span>
            </td>
          </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\business_matching\webapp\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>