...
$message = $__bag->first($__errorArgs[0]); ?>
              <p class="mt-1.5 text-enji" style="font-size:13px"><?php echo e($message); ?></p>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> outline outline-2 outline-enji <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>">
...
<?php /**PATH C:\dev\business_matching\webapp\resources\views/auth/register.blade.php ENDPATH**/ ?>